...
function PostForm(props) {
	return (
		<form onSubmit={props.submitHandler} className='post-form'>
			<label className='post-form__label' htmlFor="title" required>Title of Post</label>
			<input className='post-form__input' name='title' type="text" required/>
			<label className='post-form__label' htmlFor="content">Post Content</label>
